...
import { collection_category_data } from "../../data/collection_category_data";
import { collection_type_data } from "../../data/collection_type_data";
const Create = () => {
  const fileTypes = [
    "JPG",
    "PNG",
    ...
    <div>
      ...
      <section className="relative py-24">
        ...
        <div className="container">
          <div
            className="flex justify-between items-center w-[75%] mx-auto my-0
          "
          >
            <Link href="/create/create">
              <span className="text-2xl ml-24 hover:cursor-pointer ">
                {" "}
                {/* Ensure a tag is used within Link for valid HTML */}
                <MdArrowBack />
              </span>
            </Link>
          ...
          <div className="mx-auto max-w-[48.125rem]">
            ...
            <div className="relative">
              ...
              {/* dropdown */}
              <div className="dropdown my-1 cursor-pointer z-[9999]">
                <Collection_dropdown2
                  data={collection_category_data}
                  collection={true}
                />
              </div>
            </div>
            ...
            <button
              disabled
              className="bg-accent-lighter cursor-default rounded-full py-3 px-8 text-center font-semibold text-white transition-all btn-grad-2"
            >
              Create
            </button>
          </div>
