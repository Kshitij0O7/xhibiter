          ...
          <div className="container">
            <div className="mx-auto max-w-[48.125rem] md:flex">
              ...
              <div className="mb-12 md:w-1/2 md:pr-8">
                ...
                <button className="bg-accent shadow-accent-volume hover:bg-accent-dark rounded-full py-3 px-8 text-center font-semibold text-white transition-all btn-grad-2">
                  Update Profile
                </button>
              </div>
              {/* <!-- Avatar --> */}
