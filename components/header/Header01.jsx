    ...
    <>
      ...
      <header className="js-page-header fixed top-0 z-20 w-full backdrop-blur transition-colors">
        <div className="flex items-center px-4 py-4 xl:px-24 ">
          ...
          {/* End  logo */}
          <ul className="flex flex-col lg:flex-row ml-12 bg-[#80808071] hover:bg-accent  rounded-lg">
            {/* create */}
            <li className="group">
              <Link href="/create/create">
                <button className="text-jacarta-700 font-display hover:text-white focus:text-white  dark:focus:text-white flex items-center justify-between py-2.5 text-base dark:text-white lg:px-5 ">
                  <span
                    className={
                      isChildrenPageActive(route.asPath, "/create/create")
          ...
          <ul className="flex flex-col lg:flex-row ml-3 bg-[#80808071] hover:bg-accent  rounded-lg">
            {/* create */}
            <li className="group">
              <Link href="/event">
                <button className="text-jacarta-700 font-display hover:text-white focus:text-white  dark:focus:text-white flex items-center justify-between py-2.5 text-base dark:text-white lg:px-5">
                  <span
                    className={
                      isChildrenPageActive(route.asPath, "/event")
                        ? "text-accent dark:text-accent"
                        : ""
                    }
                  >
