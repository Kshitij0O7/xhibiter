      ...
      <section className="dark:bg-jacarta-800 relative py-24">
        ...
        <div className="container">
          ...
          <div className="mt-10 text-center">
            <Link
              href="/rankings"
              className="bg-accent shadow-accent-volume hover:bg-accent-dark btn inline-block rounded-full py-3 px-8 text-center font-semibold text-white transition-all btn-grad-2"
            >
              Go to Rankings
            </Link>
          </div>
